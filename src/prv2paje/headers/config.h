...
#define PAJE_CONTAINER_NAME_NODES "Nodes"
#define PAJE_CONTAINER_NAME_CPU "Cpu"
#define PAJE_CONTAINER_NAME_APP "Application"
#define PAJE_CONTAINER_NAME_TASK "Task"
#define PAJE_CONTAINER_NAME_THREAD "Thread"

#define PAJE_CONTAINER_ALIAS_ROOT PAJE_CONTAINER_NAME_ROOT
#define PAJE_CONTAINER_ALIAS_NODES PAJE_CONTAINER_NAME_NODES
#define PAJE_CONTAINER_ALIAS_CPU PAJE_CONTAINER_NAME_CPU
#define PAJE_CONTAINER_ALIAS_APP PAJE_CONTAINER_NAME_APP
#define PAJE_CONTAINER_ALIAS_TASK PAJE_CONTAINER_NAME_TASK
#define PAJE_CONTAINER_ALIAS_THREAD PAJE_CONTAINER_NAME_THREAD
